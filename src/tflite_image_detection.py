...
parser.add_argument('--modeldir', help='directory of model',
                    default='/home/user/Documents/Image_Recognition')
parser.add_argument('--graph', help='detect.tflite',
                    default='detect.tflite')
parser.add_argument('--labels', help='labels.txt',
                    default='labels.txt')
parser.add_argument('--threshold', help='Minimum confidence threshold for displaying detected objects',
                    default=0.5)
parser.add_argument('--image', help='assets/image.jpg',
                    default=None)
parser.add_argument('--imagedir', help='assets',
                    default=None)
